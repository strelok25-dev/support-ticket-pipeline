...
# Импортируем функцию генерации (убедись, что файл agents/draft_generator.py существует)
...
try:
    ...
    # В CI моделей нет. Ставим None. 
    # Тесты пройдут, потому что мы мокаем run_pipeline в test_unit.py
